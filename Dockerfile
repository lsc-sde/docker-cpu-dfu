...
# Use the scipy_nhsx dockerfile as an example
...
ARG OWNER=vvcb
ARG BASE_CONTAINER=jupyter/tensorflow-notebook:2023-07-26
FROM $BASE_CONTAINER

LABEL maintainer="vvcb"
LABEL image="dfu-tensorflow-code-server"
...
# COPY ./bc_environment_non_versioned.yaml environment.yaml
